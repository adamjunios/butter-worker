    ...
    <div class ="leftcolumn">
      <div class="card">
        ...
        <div id="id01" class="modal" style="display:block;">
          <form class="modal-content animate foremModal"  method="POST" action="" >
            <span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close Modal">
             &times;</span>
            <div class="imgcontainer" style="background-color:blue;color:white;">
              <h2>Yakin Hapus Data ?</h2>          
            </div>
            <hr>
            <div class="leftforem">
              <label>NIP</label>
                <input type="text" name="nip"  value="<?=$nip?>" disabled="disabled">
              ...
              <label>Tanggal Lahir</label>
                <input type="date" name="tgl_lahir" class="date" style="height:49px;" value="<?=$tgl_lahir?>" 
                 disabled="disabled" >
              <br>
            </div>
            <div class="rightforem">    
              <label>Nama</label><br>
                <input type="text" name="nama" value="<?=$nama?>" disabled="disabled"  >
              <label>Alamat</label>
                <input type="text" name="alamat" value="<?=$alamat?>" disabled="disabled"><br>
              <label style="float:left;">No. Telp</label><label style="padding-left: 38%;">Jabatan</label><br>
                <input type="text" name="no_t" value="<?=$no_t?>"  style="width:49%;float:left;" disabled="disabled">
                <input type="text" name="jab" value="<?=$jab?>" style="width:49%;float:right;" disabled="disabled">
            </div>
            <hr>   
            <input type="submit" name="hapus" value="HAPUS" class="forembtn" style="width:100%;height:8%;">
            <a href="ngedit.php?id=<?=$nip?>">EDIT DATA</a>
